...
export const createNewList = route(
...
export const addMovieToList = route(
  { method: "post", auth: true },
  async (req, res) => {
...
export const deleteMovieFromList = route(
  { method: "post", auth: true },
  async (req, res) => {
    if (req.method != "POST") {
      return res.send(400);
...
export const getUserLists = route(
...
export const getListPosterPreview = route(
  { method: "get", auth: true },
  async (req, res) => {
